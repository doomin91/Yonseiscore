...
-- 테이블 데이터 scoreproject.exam_match_list:~6 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `exam_paper_list` (
  ...
  `EPL_PATH` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '시험지',
...
INSERT INTO `exam_paper_list` (`EPL_SEQ`, `EPL_RA_SEQ`, `EPL_STUDENT_SEQ`, `EPL_PATH`, `EPL_STATUS`, `EPL_REG_DATE`, `EPL_DEL_YN`) VALUES
	(23, 14, 1, NULL, 0, '2020-09-01 17:30:20', 'N');
...
-- 테이블 데이터 scoreproject.exam_question_list:~14 rows (대략적) 내보내기
...
INSERT INTO `exam_type_list` (`ETL_SEQ`, `ETL_ROUND`, `ETL_LEVEL`, `ETL_NAME`, `ETL_DATE`, `ETL_STATUS`, `ETL_UPLOAD_STATUS`, `ETL_COMMENT`, `ETL_REG_DATE`, `ETL_DEL_YN`) VALUES
	(1, 1, 0, '1학기 중간 고사', '2020-08-20', 2, 0, '', '2020-08-20 19:35:50', 'N'),
	(2, 1, 2, '1학기 기말 고사', '2020-08-23', 1, 2, '', '2020-08-20 19:36:37', 'N'),
	(3, 1, 1, '2학기 중간고사', '2020-08-26', 0, 0, '', '2020-08-20 19:36:59', 'N'),
	(4, 2, 0, '123', '2020-08-15', 0, 0, '123', '2020-08-29 16:17:23', 'N'),
	(5, 2, 0, '123', '2020-08-15', 0, 0, '123', '2020-08-29 16:17:37', 'N'),
	(6, 2, 0, '123', '2020-08-29', 0, 2, '123', '2020-08-29 16:20:26', 'N'),
	(7, 5, 0, '123', '2020-08-29', 0, 0, '123', '2020-08-29 16:20:35', 'N'),
	(8, 3, 0, '123', '2020-08-29', 0, 0, '123', '2020-08-29 16:21:33', 'N'),
	(9, 4, 0, '213', '2020-08-29', 0, 2, '123', '2020-08-29 16:21:48', 'N'),
	(10, 2, 0, '213', '2020-08-29', 0, 0, '123', '2020-08-29 16:21:56', 'N'),
	(11, 1, 0, '123', '2020-09-04', 0, 0, '123', '2020-08-29 16:23:13', 'N'),
	(13, 1, 1, '1', '1991-12-12', 0, 0, '123', '2020-08-29 16:55:05', 'N'),
	(14, 3, 2, '두민두민', '2020-08-30', 0, 0, '123', '2020-08-29 16:55:40', 'N');
